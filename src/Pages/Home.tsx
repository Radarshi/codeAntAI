                    ...
                    <div className={`flex flex-col gap-4 border-b p-4`}>
                        <div className={`flex justify-between items-center flex-wrap gap-4`}>
                            ...
                            <div className={`flex gap-2`}>
                                <a href="/dashboard"><button className={`flex text-xs items-center p-2 px-4 gap-2 rounded-md border`}>
                                    <ArrowPathIcon className={`size-4`}/>
                                    Refresh All
                                </button></a>
                                <button
                                    className={`flex text-xs items-center p-2 px-4 gap-2 bg-[#1570EF] text-white rounded-md`} onClick={()=>{alert("Service not available at this moment.")}}>
